...
tests =
  ...
  [
    ...
    unitTest "resolveExplicitHosts: present" test_resolveExplicitHostsPresent,
    unitTest "resolveExplicitHosts: empty" test_resolveExplicitHostsEmpty,
    unitTest "resolveTargets: CLI overrides config" test_resolveTargetsCliOverridesConfig,
    unitTest "resolveTargets: from tags" test_resolveTargetsFromTags,
    unitTest "resolveTargets: defaults only" test_resolveTargetsDefaultsOnly,
    unitTest "resolveTargets: tags override defaults" test_resolveTargetsTagsOverrideDefaults,
    unitTest "resolveTargets: no tags no defaults" test_resolveTargetsNoTagsNoDefaults,
    unitTest "resolveTargets: empty tag hosts suppresses broadcast" test_resolveTargetsEmptyTagHostsSuppresses,
    ...
    unitTest "filterTargets: all pass" test_filterTargetsAllPass,
