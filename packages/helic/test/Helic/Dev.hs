...
conf :: Config
conf =
  Config (Just "dev") (Just def) (Just (NetConfig (Just True) Nothing (Just 11111) Nothing Nothing Nothing Nothing Nothing Nothing)) Nothing Nothing Nothing Nothing (Just True)
