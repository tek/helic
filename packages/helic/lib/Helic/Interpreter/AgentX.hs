...
interpretAgentX ::
  Members [EventConsumer XClipboardEvent, Events Event, Reader InstanceName, XClipboard !! Text, ChronosTime] r =>
  Members [Events XClipboardEvent, Log, Error Text, Race, Resource, Async, Embed IO, Final IO] r =>
